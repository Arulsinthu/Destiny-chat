          ...
          ElevatedButton(
            ...
            onPressed: () {
              ...
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => NewPublicScreen()));
            },
                                  ...
                                  onTap: () {
                                    ...
                                    Navigator.of(context).pushNamed(
                                        ...
                                        arguments: ScreenArguments(
                                          username:
                                              groupDocs[index]['Id'].toString(),
                                          chatRoomId: groupDocs[index]['Docid']
                                              .toString(),
                                          imageUrl:
